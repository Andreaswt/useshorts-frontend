...
export const EmailUserResubscribed = () => {
  const login = `${baseUrl}/login`;

  return (
    <Html>
      <Head />
      <Preview>You are now resubscribed</Preview>
      <Body style={bodyStyle}>
        ...
        <Container style={mainContainerStyle}>
          ...
          <Text style={normalTextStyle}>
            We&apos;re thrilled to have you start using Shorts again. To start
            using Shorts again, following the following steps.
          </Text>
          <Text style={normalTextStyle}>
            <ol>
              ...
              <li style={{ marginBottom: "16px" }}>
                <Text style={normalTextNoMarginStyle}>
                  Upload a video, or edit an old one
                </Text>
              </li>
            </ol>
          </Text>
          <Text style={normalTextStyle}>
            <strong>Login instructions: </strong> Follow the link below to log
            in:
          </Text>
...
export default EmailUserResubscribed;
